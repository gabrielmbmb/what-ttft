...
// TestConfigBaseURLDefaultsToTogether verifies the default base URL and trailing-slash trimming.
func TestConfigBaseURLDefaultsToTogether(t *testing.T) {
...
func TestConfigAPIKeyPrefersInlineThenEnv(t *testing.T) {
	...
	const keyEnv = "TOGETHER_TEST_KEY"
